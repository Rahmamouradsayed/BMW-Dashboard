    ...
    am5.ready(function () {
        ...
        var xAxis = chart.xAxes.push(
            am5xy.CategoryAxis.new(root, {
                maxDeviation: 0.3,
                categoryField: "class", // Update to match the field name from the server
                renderer: xRenderer,
        ...
        var series = chart.series.push(
            am5xy.ColumnSeries.new(root, {
                ...
                xAxis: xAxis,
                yAxis: yAxis,
                valueYField: "value", // Update to match the field name from the server
                sequencedInterpolation: true,
                categoryXField: "class" // Update to match the field name from the server
            })
        );
